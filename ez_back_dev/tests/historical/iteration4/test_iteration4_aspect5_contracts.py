...
FIXTURE = fixture_path("historical", "iteration4", "iteration4_aspect5_manifest_v1.json")
...
def test_aspect5_manifest_keeps_packages_and_protected_sources_frozen():
    ...
    parent = fixture_path("historical", "iteration4", manifest["parent"]["fixture"])
...
def test_context_rag_document_freezes_memory_citations_and_dense_fallback():
    text = canonical_document_path(
        "docs/iteration-4-aspect-5-context-rag-contract.md"
