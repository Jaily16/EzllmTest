...
from service.agentContracts import redact_sensitive_text
...
class RetrievalCitation(_StrictToolModel):
...
class RetrievalQueryEvidence(_StrictToolModel):
...
class ToolRetrievalEvidence(_StrictToolModel):
    policy_version: Literal["iteration4-aspect5-v1"] = "iteration4-aspect5-v1"
    strategy: Literal["dense_v1", "hybrid_rrf_v1", "hybrid_rerank_v1"]
