...
/**
 * 处理begin项目分析 regeneration，并保持现有输入输出约定。
 */
...
/**
 * 处理finish项目分析 regeneration，并保持现有输入输出约定。
 */
...
/**
 * 请求并获取项目分析 bundle，并保持现有状态与错误处理语义。
 *
...
/**
 * 判断工作流路由 allowed，并保持现有状态与错误处理语义。
 */
