...
import { TEST_WORKSPACES } from "@/features/testing/config/testWorkspaces";
import {
...
import { confirmProjectAnalysisRegeneration } from "@/shared/ui/confirmations";
...
/**
 * 处理测试菜单 is complete，并保持现有输入输出约定。
 */
...
/**
 * 启动测试计划，并保持现有状态与错误处理语义。
 */
const startTestPlan = () => runTestPlan(false);
/**
 * 取消测试计划，并保持现有状态与错误处理语义。
 */
