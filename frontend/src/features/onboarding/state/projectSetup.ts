...
/**
 * 处理浏览器存储 available，并保持现有输入输出约定。
 */
const storageAvailable = (): boolean => typeof window !== "undefined";

/**
 * 持久化项目初始化状态，并保持现有状态与错误处理语义。
 *
