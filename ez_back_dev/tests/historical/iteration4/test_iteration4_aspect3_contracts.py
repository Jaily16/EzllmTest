...
FIXTURE = (
    fixture_path("historical", "iteration4", "iteration4_aspect3_manifest_v1.json")
)
BASELINE = (
    fixture_path("historical", "iteration3", "iteration3_contract_baseline_v1.json")
)
CONTRACT = canonical_document_path("docs/iteration-4-aspect-3-runtime-contract.md")
...
def test_checkpoint_source_has_no_pickle_dynamic_import_or_upstream_redis_saver():
    source = (BACKEND_ROOT / "service" / "agent" / "checkpoint.py").read_text(
        encoding="utf-8"
    )
