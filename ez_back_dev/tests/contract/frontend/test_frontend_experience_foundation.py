...
STYLES_ROOT = FRONTEND_ROOT / "src" / "shared" / "styles"
...
def test_foundation_styles_are_imported_in_locked_order():
    ...
    assert source.index("./shared/plugins/elementPlus") < positions[0]
...
def test_tokens_cover_the_locked_design_system_contract():
    ...
    required = {
        ...
        "--ez-z-sticky": "100",
        "--ez-z-overlay": "2000",
        "--ez-motion-easing": "cubic-bezier(0.2, 0, 0, 1)",
    }
...
def test_workflow_stepper_preserves_props_and_exposes_state_semantics():
    source = read("ez_front_dev/src/features/workspace/components/WorkflowStepper.vue")
