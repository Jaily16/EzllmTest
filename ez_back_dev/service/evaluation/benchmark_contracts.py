...
class BenchmarkReport(_BenchmarkModel):
    ...
    fixture_version: Literal["iteration4-agent-performance-v1"] = "iteration4-agent-performance-v1"
    ...
    telemetry_export_status: Literal["disabled", "exported", "export_failed", "not_flushed"]
