...
def redact_sensitive_text(value: str) -> str:
    """Redact assigned secret values without treating ordinary words as secrets."""
...
def typed_tool_definitions() -> tuple[TypedToolDefinition, ...]:
    """Return the catalog-derived definition set for workbench/MCP adapters."""
...
def transition(
    ...
    """Apply one validated reference transition without performing I/O."""
