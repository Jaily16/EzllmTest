// 声明测试工作区的步骤依赖和选择字段，所有页面使用同一失效与恢复规则。
import type { TestMenuState } from "@/entities/project/model/analysis";
import acceptanceTesting from "@/entities/workflow/assets/illustrations/acceptance-testing.png";
import apiTesting from "@/entities/workflow/assets/illustrations/api-testing.png";
import databaseTesting from "@/entities/workflow/assets/illustrations/database-testing.png";
import functionalTesting from "@/entities/workflow/assets/illustrations/functional-testing.png";
import integrationTesting from "@/entities/workflow/assets/illustrations/integration-testing.png";
import nonfunctionalTesting from "@/entities/workflow/assets/illustrations/nonfunctional-testing.png";
import uiTesting from "@/entities/workflow/assets/illustrations/ui-testing.png";
import unitTesting from "@/entities/workflow/assets/illustrations/unit-testing.png";
